...
namespace Hospital_onco.Migrations
{
    ...
    [Migration("20210709180645_FixUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoctorInvestigation", b =>
                {
                    ...
                    b.HasKey("DoctorsId", "InvestigationsId");

                    b.HasIndex("InvestigationsId");

                    b.ToTable("DoctorInvestigation");
                });

            modelBuilder.Entity("Hospital_onco.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Hospital_onco.Models.Appointment", b =>
                {
                    ...
                    b.HasIndex("UserId", "ScheduledInvestigationId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Hospital_onco.Models.Investigation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Hospital_onco.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "305d4add-5b76-44e5-b63d-f5fd4e23211a",
                            ConcurrencyStamp = "22a2911f-ffb0-413b-b9bc-a3f825e9853b",
                            Name = "AppUser",
                            NormalizedName = "APPUSER"
                        },
                        new
                        {
                            Id = "fc5f4e96-501e-4100-9124-2b7592afa7f5",
                            ConcurrencyStamp = "f17a35c8-992b-4201-9b37-68708591ad28",
                            Name = "AppAdmin",
            ...
            modelBuilder.Entity("DoctorInvestigation", b =>
                {
                    b.HasOne("Hospital_onco.Models.Doctor", null)
                        .WithMany()
                        .HasForeignKey("DoctorsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Hospital_onco.Models.Investigation", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Hospital_onco.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
